    ...
    public partial class InitialDomain : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AvailabilityRuleId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    DoctorId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "UX_Appointments_ActiveAvailabilitySlot",
                table: "Appointments",
                column: "AvailabilitySlotId",
                unique: true,
                filter: "[Deleted] = 0 AND [Status] <> 'Cancelled'");

            migrationBuilder.CreateIndex(
                name: "UX_AvailabilityRules_Doctor_Month_Day_Time",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailabilitySlots_DoctorId_SlotDate_Status",
                table: "AvailabilitySlots",
            ...
            migrationBuilder.CreateIndex(
                name: "UX_Specialities_ActiveName",
                table: "Specialities",
                column: "Name",
                unique: true,
                filter: "[Deleted] = 0");
